...
from main import app, TranscribeRequest, ChatRequest, SpeakRequest
...
def test_converse_endpoint(mock_azure_services):
    ...
    with patch('main.transcribe_audio') as mock_transcribe, \
         patch('main.chat') as mock_chat, \
         patch('main.speak_text') as mock_speak:
        
        mock_transcribe.return_value = {"transcription": "Hello", "confidence": "High"}
